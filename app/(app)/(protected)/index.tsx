...
const HomePage = () => {
  ...
  return (
    <View className="flex-1 bg-background mt-8 mb-8">
    <ScrollView style={{ flex: 1, backgroundColor: '#F5F5F5' }}>
      ...
      <Image
				...
				/>
        <Text className="text-lg font-semibold mt-3" style={{ fontSize: 25, padding:15 }}>RentEase</Text>
      </View>
      ...
      {/* Product Sections */}
      {['Top Picks for You', 'Recently Viewed', 'Popular in Islamabad'].map((section) => (
